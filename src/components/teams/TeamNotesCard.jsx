...
export default function TeamNotesCard({ team, form, editing, onField }) {
  ...
  return (
    <TeamSection icon={StickyNote} title="Team Notes">
      {editing ? (
        <Textarea value={t?.ministry_notes || ''} onChange={(e) => onField('ministry_notes', e.target.value)} rows={4} placeholder="Add notes about this team…" />
      ) : (
