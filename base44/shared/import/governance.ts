...
export const FIELD_GOVERNANCE: Record<string, Record<string, FieldPolicy>> = {
  ...
  ChampionHousehold: {
    ...
    household_name: policy({
      ...
      sourceAliases: ['household', 'household name', 'family', 'family name'],
      allowBlankFill: true,
    ...
    address: policy({
      ...
      entity: 'ChampionHousehold',
      ownership: OWNERSHIP.SHARED_REVIEW,
      sourceAliases: ['address', 'street', 'street address', 'address 1', 'address1'],
      allowBlankFill: true,
      requiresReconciliation: true,
    ...
    home_phone: policy({
      ...
      entity: 'ChampionHousehold',
      ownership: OWNERSHIP.SHARED_REVIEW,
      sourceAliases: ['home phone', 'home', 'home number', 'phone', 'phone number', 'telephone'],
      allowBlankFill: true,
      requiresReconciliation: true,
    ...
    email: policy({
      ...
      entity: 'ChampionHousehold',
      ownership: OWNERSHIP.SHARED_REVIEW,
      sourceAliases: ['email', 'e-mail', 'email address', 'e-mail address', 'household email'],
      allowBlankFill: true,
      requiresReconciliation: true,
      emailLowercase: true,
    ...
    cumulative_registrations: policy({
      ...
      entity: 'ChampionHousehold',
      ownership: OWNERSHIP.FAMILYLIFE_MANAGED,
      sourceAliases: ['cumulative registrations', 'cumulative', 'total registrations', 'registrations cumulative'],
      allowBlankFill: true,
    ...
    free_couple_registrations_used: policy({
      ...
      entity: 'ChampionHousehold',
      ownership: OWNERSHIP.FAMILYLIFE_MANAGED,
      sourceAliases: ['free couple registrations used', 'free registrations used', 'free couple used', 'comp used'],
      allowBlankFill: true,
    ...
    free_couple_registrations_available: policy({
      ...
      entity: 'ChampionHousehold',
      ownership: OWNERSHIP.FAMILYLIFE_MANAGED,
      sourceAliases: ['free couple registrations available', 'free registrations available', 'free couple available', 'comp available'],
      allowBlankFill: true,
    ...
    registrations_needed_for_next_free_registration: policy({
      ...
      entity: 'ChampionHousehold',
      ownership: OWNERSHIP.FAMILYLIFE_MANAGED,
      sourceAliases: ['registrations needed for next free registration', 'needed for next free', 'needed for next', 'registrations needed'],
      allowBlankFill: true,
    ...
    group_name: policy({
      ...
      entity: 'ChampionHousehold',
      ownership: OWNERSHIP.FAMILYLIFE_MANAGED,
      sourceAliases: ['group', 'group name', 'groupname', 'small group'],
      allowBlankFill: true,
    ...
    champion_status: policy({
      ...
      entity: 'ChampionHousehold',
      ownership: OWNERSHIP.FAMILYLIFE_MANAGED,
      sourceAliases: ['champion status', 'champion'],
      allowBlankFill: true,
